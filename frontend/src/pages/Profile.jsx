    ...
    return (
      <div className="mobile-container">
        ...
        <main className="mobile-main">
          <div
            className="navigation-achievement"
          ...
          <div className="card-row">
            <div className="nav-todo-post" onClick={() => navigate("/todo-list")}>
              <img
                src={imageCeklis}
                alt="Ceklis"
                style={{
            ...
            <div className="nav-todo-post" onClick={() => navigate("/create-post")}>
              <img
                src={imageEdit}
                alt="Edit"
                style={{
